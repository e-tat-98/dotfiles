# Generated by Powerlevel10k configuration wizard on 2022-08-19 at 09:50 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=139
  ...
  function my_git_formatter() {
    ...
    local   modified='✏️ %0F' # black foreground
    local  untracked='%0F' # black foreground
    local conflicted='⚡️ %1F' # red foreground
